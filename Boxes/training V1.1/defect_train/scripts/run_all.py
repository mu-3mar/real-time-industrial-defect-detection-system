...
from export.export_engine import export_engine
...
def main():
    ...
    logger.info("Step 3: Exporting to TensorRT engine")
    try:
        export_engine(run_dir)
    except Exception as e:
        logger.warning(f"TensorRT export skipped/failed: {e}")

    # 4. Quantize
    logger.info("Step 4: Quantizing")
